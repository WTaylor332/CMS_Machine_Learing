...
def rnn(form, op, lossFunc):
    ...
    # model = keras.models.Sequential([
    #     keras.Input(shape=form),
    #     keras.layers.Bidirectional(keras.layers.GRU(80, return_sequences=True, activation='relu')),
    #     # keras.layers.Bidirectional(keras.layers.GRU(60, return_sequences=True, activation='relu')),
    #     # keras.layers.Bidirectional(keras.layers.GRU(40, return_sequences=True, activation='relu')),
